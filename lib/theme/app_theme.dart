  ...
  static ThemeData get dark {
    return ThemeData(
      ...
      textTheme: const TextTheme(
        displayLarge:  TextStyle(color: JournalColors.textPrimary, fontWeight: FontWeight.w700),
        displayMedium: TextStyle(color: JournalColors.textPrimary, fontWeight: FontWeight.w600),
        ...
        labelLarge:    TextStyle(color: JournalColors.textPrimary,   fontWeight: FontWeight.w600),
      ),
